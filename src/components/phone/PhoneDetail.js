...
const PhoneDetail = ({ description, img, isValidData, model, price, screen, hidePhoneDetail }) => (
  <div className='phone-detail modal' hidden={!isValidData}>
    <div className='modal-dialog'>
      <div className='modal-content'>
        <div className='modal-header'>

          <h5 className='modal-title'>{model}</h5>
          <button className='close' type='button' aria-label='Close' onClick={hidePhoneDetail}>
        ...
        <div className='modal-body'>
          <div className='container text-center'>
            ...
            <div className='row'>
              <div className='col'>
                <img className='img' src={img} alt={model} />
              </div>
            </div>
            ...
            <div className='row'>
              ...
              <div className='col-sm'>
                <strong>Screen:</strong> {screen} inch
              </div>
              <div className='col-sm'>
